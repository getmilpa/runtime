...
/**
 * Generates the static API reference site for milpa/runtime.
 *
...
$config = new Milpa\Docs\SiteConfig(
    brand: 'Milpa Runtime',
    nsPrefix: 'Milpa\\Runtime\\',
    installCommand: 'composer require milpa/runtime',
    repoUrl: 'https://github.com/getmilpa/runtime',
    pagesUrl: 'https://getmilpa.github.io/runtime/',
    heroParagraph: 'The bootable Milpa kernel — composes core, container, events, http and plugin into a '
        . 'running app with a config-driven plugin registry, capability checks before boot, and lifecycle '
        . 'events. Zero database, zero magic.',
    utmContent: 'runtime',
);
